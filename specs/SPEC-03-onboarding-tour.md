...
**Clarifications:** вісім питань, усі закриті до схвалення — п'ять закрила людина (Q-1, Q-4, Q-6,
Q-7, Q-8), три координатор (Q-2, Q-3, Q-5). Кожне живе як рішення з автором — D17…D24, — а не як
мітка в тексті: `spec-creator` не пише файла, доки питання відкрите, бо половина спеки на диску
гірша за її відсутність — наступний агент планує проти неї. Розгорнуто в `## Open questions`.
**Supersedes:** _Немає._
