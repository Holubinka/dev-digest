...
**Схвалення не переноситься.** `**Status:**` і рядок реєстру не змінені, але схвалення
2026-08-16 стосувалося **сорока п'яти** критеріїв, а не **сімдесяти шести**. Шість питань, що їх
доповнення відкрило, людина закрила того ж дня (див. `## Open questions`), тож відкритих питань у
спеці немає — але сам набір AC-46…AC-76 схвалює людина окремим актом, і до того він не є
підставою для планування.
