...
**Status:** approved
**Created:** 2026-08-18
**Clarifications:** одинадцять питань, усі закриті людиною за три раунди — Q-1…Q-7, тоді Q-8…Q-10,
тоді Q-11. Кожне живе як рішення D11…D23, а не як мітка в тексті: `spec-creator` не пише файла,
доки питання відкрите. Q-11 поставлено вже ПІСЛЯ відповіді на Q-8 — ціну зміряли пізніше, і вимір
розвернув рішення: третину фічі знято цілком (D23).
