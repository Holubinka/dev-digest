...
| [`SPEC-05-export-to-ci.md`](SPEC-05-export-to-ci.md) | server, client, reviewer-core, agent-runner (new) | Approved 2026-08-26 · amendment AC-123…AC-133 (D21) approved 2026-08-26 · third amendment 2026-08-26 (D22, AC-134): AC-52 fork check corrected to `head.repo.full_name != github.repository`, still approved · fourth amendment 2026-08-26 (D23, AC-135…AC-149): one workflow file per agent, named from the agent slug; AC-16, AC-20, AC-31, AC-51, AC-68, AC-85 rewritten; **Q-11 open** (fate of the inherited `devdigest-review.yml`), still approved · **re-approved 2026-08-26 at 149 criteria, D1…D24**: Q-11 closed (D24 — the inherited `devdigest-review.yml` is deleted by the same commit, at the price of a new delete capability on the GitHub port and of losing any manual edit in that file); AC-145 and AC-146 rewritten to that single path, no new criteria |
