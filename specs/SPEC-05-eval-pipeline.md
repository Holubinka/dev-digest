...
- **N5** — Пакет `evals/` у корені репозиторію (лабораторний harness для `.claude/skills/*` і
  ...
  _Дописано 2026-08-27:_ вимоги на нього тепер має `SPEC-06-eval-harness.md`. Межа лишається
  тією самою — цей пункт не змінено, лише названо документ по той її бік.
