...
/** Nothing here declares a property a breakpoint changes: the notes and the
 *  input list are full width in every layout, and the one thing that responds
 *  on this page is the rail/content split in `app/globals.css`. */
export const s = {
  note: {
    margin: 0,
    padding: "10px 14px",
