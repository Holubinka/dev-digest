...
live in the root `CLAUDE.md`; this file only covers what is specific to this package.
...
- **Read `../server/CLAUDE.md`** before changing an exported type — the server consumes
