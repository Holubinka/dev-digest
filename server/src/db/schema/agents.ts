...
export const agentSkills = pgTable(
  ...
  (t) => ({
    ...
    // The primary key leads with `agent_id`, so it does nothing for the
    // skills module's reads, which all start from a skill: how many agents
    // bind it, and what those agents have run.
