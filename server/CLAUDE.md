...
Fastify 5 + Drizzle over Postgres. Repo-wide rules live in the root `CLAUDE.md`; this
...
- **Read `../reviewer-core/CLAUDE.md`** before changing anything the review engine
